            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Article">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.article.fields.introdution') }}
                        </th>
                        <th>
                    ...
                    @foreach($articles as $key => $article)
                        <tr data-entry-id="{{ $article->id }}">
                            ...
                            <td>
                                    ...
                                    <a class="btn btn-xs btn-info" href="{{ route('articles.edit', $article->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>

                                    <form action="{{ route('articles.destroy', $article->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
$(function () {
  ...
  let deleteButton = {
    ...
    url: "{{ route('articles.massDestroy') }}",
